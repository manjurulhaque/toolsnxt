...
export default function PdfCompressPage() {
  ...
  return (
    <ToolPage>
        <ToolPanel>
          <ToolIntro eyebrow="Local PDF tool" title="PDF Compress">
        ...
        <ToolPanel>
          <PanelHeader eyebrow="Compression settings" title="Output" badge={pdfFile ? `${pdfFile.pageCount} pages / ${formatBytes(pdfFile.file.size)}` : "No file"} />
          ...
          {pdfFile ? (
            <div className="mt-6 space-y-5">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <SummaryTile label="Original" value={formatBytes(result?.originalSize ?? pdfFile.file.size)} />
                <SummaryTile label="Compressed" value={result ? formatBytes(result.compressedSize) : "-"} />
                <SummaryTile
                  label="Saved"
                  value={
                    savings
