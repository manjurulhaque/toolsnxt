...
export default function TimezoneConverterPage() {
  ...
  return (
    <ToolPage gridClassName="lg:grid-cols-[0.92fr_1.08fr]">
        <ToolPanel>
          <ToolIntro eyebrow="Time tool" title="Timezone Converter">
        ...
        <ToolPanel>
          <PanelHeader eyebrow="Result" title="Converted Time" badge={targetOffset} />
