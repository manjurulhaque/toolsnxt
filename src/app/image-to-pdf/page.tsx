...
export default function ImageToPdfPage() {
  ...
  return (
    <ToolPage gridClassName="lg:grid-cols-[0.88fr_1.12fr]">
        <ToolPanel>
          <ToolIntro eyebrow="Local tool" title="Image to PDF Converter">
        ...
        <ToolPanel>
          <PanelHeader eyebrow="PDF pages" title="Selected Images" badge={`${images.length} files / ${formatBytes(totalSize)}`} />
